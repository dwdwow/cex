...
//	return cex.Request(u, FuturesNewOrderConfig, FuturesNewOrderParams{Symbol: symbol, PositionSide: u.cfg.fuPosSide, Type: ordType, Side: side, ReduceOnly: SmallTrue}, opts...)
//}
