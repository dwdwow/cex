...
type SpotCancelNewOrderParams struct {
	Symbol                  string                      `s2m:"symbol,omitempty"`
	Type                    OrderType                   `s2m:"type,omitempty"`
	Side                    OrderSide                   `s2m:"side,omitempty"`
	Quantity                float64                     `s2m:"quantity,omitempty"`
...
type SpotCancelNewOrderRawResult struct {
	Code int    `json:"code"`
	Msg  string `json:"msg"`
...
type SpotCancelNewOrderResult struct {
	OK          bool            `json:"OK"`
...
var SpotCancelNewOrderConfig = cex.ReqConfig[SpotCancelNewOrderParams, SpotCancelNewOrderResult]{
	ReqBaseConfig: cex.ReqBaseConfig{
		BaseUrl:          ApiBaseUrl,
	...
	HTTPStatusCodeChecker: HTTPStatusCodeChecker,
	RespBodyUnmarshaler:   spotOrderCancelReplaceUnmarshaler,
}
